...
IF THIS IS THE FIRST TIME DOING ALL OF THIS (aka "starting from scratch"), do 2A and 3A
2A) cd /root
3A) git clone https://github.com/ka9cql/allstar.git


IF YOU'VE DONE SOME OF THIS BEFORE, and only need to update your code to the latest, do 2B and 3B
2B) cd /root/allstar
3B) git pull
